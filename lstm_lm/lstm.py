...
class LSTMRNN:
    ...
    def __theano_build__(self):
        ...
        def forward_prop_step(x_t, s_t1_prev, s_t2_prev,s_t3_prev,c_t1_prev,c_t2_prev,c_t3_prev):
            ...
            return [o_t, s_t1, s_t2,s_t3,c_t1_prev,c_t2_prev,c_t3_prev]
        
        [o, s,s1, s2,c1,c2,c3], updates = theano.scan(
            forward_prop_step,
            sequences=x,
